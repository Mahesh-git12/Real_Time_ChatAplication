...
import {
  Box, Typography, TextField, Button, Paper, IconButton, Grid, Avatar, useTheme, useMediaQuery,
} from "@mui/material";
...
function Chat({ userId, username }) {
  ...
  const sendMessage = () => {
    ...
    const messageData = {
      userId, username, content: message.trim(), createdAt: new Date().toISOString()
    };
      ...
      <Grid container justifyContent="center" alignItems="center" sx={{ height: "100vh" }}>
        <Grid item xs={12} md={10} lg={8}>
          <Paper
            elevation={24}
            sx={{
              display: "flex", p: 0, borderRadius: 4,
              height: isMobile ? "94vh" : 620, minHeight: isMobile ? "auto" : 620,
              maxHeight: 700, bgcolor: "rgba(28,30,43,0.97)",
              overflow: "hidden", boxShadow: "0 6px 48px #000a",
            }}
          >
            {/* Sidebar with online users */}
            <Box sx={{
              width: { xs: 120, sm: 190 }, flexShrink: 0, bgcolor: "#222849", py: 3,
              px: { xs: 1, sm: 2 }, display: "flex", flexDirection: "column", alignItems: "center",
              borderRight: "2px solid #373e69", minHeight: "100%"
            }}>
              ...
              {onlineUsers.length === 0 ? (
                ...
                onlineUsers.map((user) => (
                  <Box key={user.id}
                    sx={{
                      display: "flex", alignItems: "center", mb: 2, p: 1, borderRadius: 3,
                    ...
                    <Avatar
                      sx={{
                        ...
                        fontWeight: "bold", mr: 1.5, width: 34, height: 34, fontSize: 17, color: "#21213a",
                      }}>
            ...
            {/* Chat Main */}
            <Box sx={{
              flex: 1, p: { xs: 1, sm: 2 }, display: "flex", flexDirection: "column",
              ...
              {/* Messages */}
              <Box sx={{
                flexGrow: 1, overflowY: "auto", mb: 2, px: 1,
                bgcolor: "rgba(22,25,44,0.94)",
                borderRadius: 3, boxShadow: "inset 0 2px 18px #2d274d", scrollBehavior: "smooth",
              }}>
                  ...
                  return (
                    <Box key={idx}
                      ...
                      <Box sx={{
                        ...
                        p: { xs: 1, sm: 2 }, borderRadius: 5,
                        boxShadow: sent
                          ? "0 2px 18px 0 #7f5af0bb"
                          : "0 2px 14px 0 #0a152cbb",
                        minWidth: 110, maxWidth: { xs: "70%", sm: "66%" }, transition: "box-shadow 0.15s",
                      }}>
                        {!hideHeader && (
