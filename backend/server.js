...
app.use('/api/messages', protect, messageRoutes); // GLOBAL chat route - handles all messages
...
mongoose.connect(process.env.MONGO_URI, { useNewUrlParser: true, useUnifiedTopology: true })
  .then(() => {
    server.listen(PORT, () => console.log(`Server is runninggg on the port ${PORT}`));
  })
  .catch(err => {
